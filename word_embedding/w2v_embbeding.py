...
#On récupère les coefficients trouver par le modèle du word2vec
...
#On prépare notre matrice d'embedding
embedding_matrix = np.zeros((vocab_size, embedding_dim))

#On remplie ensuite la matrice des vecteurs de coefficients du word2vec
for word, i in test_tokenizer.word_index.items():
    if i >vocab_size:
        continue
...
model = Sequential()
#La couche d'embedding utilisant la matrice d'embedding du word2vec		
...
model.add(Flatten())
#Nos couches de neurones avec un dropout de 0.3
